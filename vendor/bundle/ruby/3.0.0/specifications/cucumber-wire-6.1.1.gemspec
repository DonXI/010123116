...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<cucumber-cucumber-expressions>.freeze, ["~> 12.1", ">= 12.1.2"])
    s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["~> 17.0", ">= 17.0.1"])
    s.add_development_dependency(%q<aruba>.freeze, ["~> 2.0", ">= 2.0.0"])
    s.add_development_dependency(%q<cucumber>.freeze, ["~> 7.0", ">= 7.0.0"])
    ...
    s.add_dependency(%q<cucumber-cucumber-expressions>.freeze, ["~> 12.1", ">= 12.1.2"])
    s.add_dependency(%q<cucumber-messages>.freeze, ["~> 17.0", ">= 17.0.1"])
    s.add_dependency(%q<aruba>.freeze, ["~> 2.0", ">= 2.0.0"])
    s.add_dependency(%q<cucumber>.freeze, ["~> 7.0", ">= 7.0.0"])
